...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sarah/Git/stress_learn/experiment/learn_exp_lastrun.py',
...
trials = data.TrialHandler(nReps=0.0, method='random', 
    ...
    trialList=data.importConditions('stimuli/stim.xlsx'),
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    sound_1.setSound(word, secs=1.0, hamming=True)
    sound_1.setVolume(1.0, log=False)
    # keep track of which components have finished
    exposureComponents = [sound_1]
